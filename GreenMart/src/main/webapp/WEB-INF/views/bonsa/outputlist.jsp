...
function data_display(data) {
	...
	html += '<td>'+data.out_num*data.p_iprice+'</td>';
				...
				$.ajax({
					...
					success : function(data){
						...
						data.forEach(function (item) {
							...
							totalsPrice += parseFloat(item.p_iprice*item.out_num);
