...
#my {font-size: 40px; position: absolute; top: 20%; left:5% }
#olist { border: 3px solid #666666; position: absolute; left: 39%; width: 558px;
...
<body>
	<div id="gd">
	 <span id="my">점포 주문내역 조회</span>
	<div id="olist">
	시작일자 지정 : <input type="date" id="startdate"><br>
	종료일자 지정 : <input type="date" id="enddate"><br>
	점포 : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="jumpo"></span><input type="button" id="search" value="검색" style=" margin: 0 20px 0 50px;" class="btn"/>
