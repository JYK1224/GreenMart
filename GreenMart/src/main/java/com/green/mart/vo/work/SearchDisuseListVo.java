...
public class SearchDisuseListVo {
	...
	public SearchDisuseListVo(String dis_date, String startdate, String enddate, String d_name, String p_id,
			String p_name, int p_sprice, int st_num, int dis_num, String e_id, int s_num) {
	...
	public String toString() {
		return "SearchDisuseListVo [dis_date=" + dis_date + ", startdate=" + startdate + ", enddate=" + enddate
				+ ", d_name=" + d_name + ", p_id=" + p_id + ", p_name=" + p_name + ", p_sprice=" + p_sprice
				+ ", st_num=" + st_num + ", dis_num=" + dis_num + ", e_id=" + e_id + ", s_num=" + s_num + "]";
	}
