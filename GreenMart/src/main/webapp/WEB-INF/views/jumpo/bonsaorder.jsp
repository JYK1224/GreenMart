...
#lay {width: 90%; height: 430px; border: 3px solid #666666; position: absolute; left:5%;  margin-top: 130px; box-shadow: 3px 3px 3px 3px gray;}
#table {overflow: auto; width: 100%; height: 390px;}
span {font-size: 40px; position: absolute; top: 20%; left:6% }
